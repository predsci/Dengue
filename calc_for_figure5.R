...
## aggregate methods
## Code will genearate the required data for Figure 5 which can than be plotted
##
...
my_pop = DENVdat$attr$sedac_pop[identifiers]
my_pop = round(my_pop)
...
state_lat = DENVdat$attr[attr_ind, "sedac_lat"]
state_lon = DENVdat$attr[attr_ind, "sedac_lon"]
