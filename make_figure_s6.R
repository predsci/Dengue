##
## Calculate and create Figures S6, S7 and S8
## Effect of delay in reporting - Thailand, Mexico and Brazil
## Depending on the country the mod_name needs to change and so does the year
##
...
if (pdf == TRUE) {
	if (mod_name == "TH") {
		filename = "figure_s6.pdf"
	} else if (mod_name == "MX") {
		filename = "figure_s7.pdf"
	} else if (mod_name == "BR") {
		filename = "figure_s8.pdf"
	} else {
		filename = "figure_sXX.pdf"
	}
